...
ASchema = {
    ...
    loadRelativeFile: function (base, match, fixer, opts) {
        var R = {};
    ...
    loadRemoteCachedSchemaFiles: function (base, match, opts) {
        return ASchema.loadRelativeFile(base, match, ASchema.remoteFixer, opts);
    },
    loadRelativeSchemaFiles: function (base, match, opts) {
        return ASchema.loadRelativeFile(base, match, ASchema.relativeFileSchemaFixer, opts);
    },
